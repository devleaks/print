...
return [
	...
	'Change client' => 'Changer le client',
	'Checks' => 'Contrôles',
	'Checksum error: {0} HTVA differs: {1} vs. {2}.' => "Erreur de contrôle de somme: Les montants totaux pour la facture/note de crédit {0} diffèrent: {1} vs. {2}.",
	...
	'Extracted in {file} (everything), {clients} (clients only), and {bills} (bills only).' => "Extraction dans les fichiers {file} (tout); {clients} (clients seuls), et {bills} (factures/notes de crédit).",
	...
	'Line added.' => 'Ligne de commande ajoutéé.',
	...
	'Submit work' => 'Soumettre le travail',
	'Submit work?' => 'Soumettre le travail?',
	'Successful convertion.' => 'Document créé.',
	...
	'There are {0} OPEN bill(s)/credit note(s): {1}.' => "Il y a {0} facture(s)/note(s) de crédit dans l'état OUVERT.",
	...
	'Current status is <q>{0}</q>.' => "L'état actuel est <q>{0}</q>.",
	'{0} has no order line.' => "{0} n'a pas de ligne de commande.",
	'{0} is not filled. You have to press <q>{1}</q> to start fulfilling {0}.' => "Le/la {0} n'est pas remplie. Presser <q>{1}</q> pour la démarrer.",
	// work
	...
	'Client has not been notified yet.' => "Le client n'a pas encore été averti.",
	...
	'Work started on {0} by {1} with task <q>{2}</q>.' => "Le travail a été commencé le {0} par {1} avec la tâche <q>{2}</q>.",
	'Work completed on {0} by {1}.' => "Le travail a été terminé le {0} par {1}.",
	'Last task completed was <q>{2}</q> on {0} by {1}.' => "La dernière tâche accomplie est <q>{2}</q> le {0} par {1}.",
	'Work status is <q>{0}</q>.' => "L'état du travail est <q>{0}</q>.",
 ...
 */
	...
	/** Footer */
	'Jo and Z srl • 21-23 rue Tervaete • 1040 Brussels<br>Tél. (+32) 477 88 61 22<br>e-Mail: info@joz-srl.be • Web Site: www.joz-srl.be • VAT: BE 0756 789 050<br>Joz Bank  IBAN: BE48 3632 0307 7927 • BIC: BBRUBEBB' => 'Jo and Z srl • 21-23 rue Tervaete • 1040 Bruxelles<br>Tél. (+32) 477 88 61 22<br>e-Mail: info@joz-srl.be • Site Web: www.joz-srl.be • TVA: BE 0756 789 050<br>Banque ING IBAN: BE48 3632 0307 7927 • BIC: BBRUBEBB',
