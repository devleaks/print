...
<div class="order-print-footer">
	...
	<tr>
		...
		<td width="15%" style="text-align: right;"><?= Yii::t('store', 'HTVA') ?></td>
		<td width="15%" style="text-align: right;"><?= Yii::$app->formatter->asCurrency($model->price_htva) ?></td>
	</tr>
	<tr>
		<td colspan="2"></td>
		...
		<td style="text-align: right;"><?= Yii::t('store', 'VAT') ?></td>
		<td style="text-align: right;"><?= $model->vat_bool ? '' : Yii::$app->formatter->asCurrency($model->price_tvac - $model->price_htva) ?></td>
	</tr>
	<tr>
		<td colspan="2"></td>
		<td colspan="3"></td>

		<td style="text-align: right; font-weight: bold; font-size: 1.2em;"><?= Yii::t('store', 'TVAC') ?></td>
		<td style="text-align: right; font-weight: bold; font-size: 1.2em;"><?= Yii::$app->formatter->asCurrency($model->vat_bool ? $model->price_htva : $model->price_tvac) ?></td>
	</tr>
	</table>
