...
var docTypesColors = d3.scaleOrdinal().domain(labels)
    .range(colors);
...
*/
    ...
    dataTable
        .dimension(cli_total)
        .section(function(d) { return "Tâches qui prennent le plus de temps, classées par ordre décroissant de temps cumulé." })
