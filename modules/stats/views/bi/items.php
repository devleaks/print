...
d3.json(itmurl, function(error, data) {
	/**{
		"id":821,
...
d3.json(url, function(error, data) {
	...
	data.forEach(function(sale) {
		...
		if(sale.total_htva > 0 && apply_rebate(sale)) {
			splitted++;					
			var percents = (sale.extra_type == "REBATE_PERCENTAGE") ? -sale.extra_amount / 100 : +sale.extra_amount / 100 ;
