...
<?php if($model->lang == 'nl'): ?>
	...
	e-Mail: info@labojjmicheli.be • Web Site: www.labojjmicheli.be • BTW: BE 0428 746 631 RPM: BXL<br>
...
<?php else: ?>
	...
	e-Mail: info@labojjmicheli.be • Site Web: www.labojjmicheli.be • TVA: BE 0428 746 631 RPM: BXL<br>
