...
<?= $client->titre.' '.$client->nom ?>,
	...
	<br>
<p>
<?= Yii::t('store', 'LATE_BILL_COVER3::BEFORE_LIST') ?>
</p>

<?= $this->render('_late-bills', ['bills' => $bills]) ?>

<p>
<?= Yii::t('store', 'LATE_BILL_COVER3::AFTER_LIST') ?>
</p>
<p>
<?= Yii::t('store', 'LATE_BILL_COVER3::CALL_ACTION') ?>
</p>
<p>
<?= Yii::t('store', 'LATE_BILL_COVER3::GREETINGS') ?>
</p>
