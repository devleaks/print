...
<div class="order-print-header">
	...
	<tr>
			...
			<td width="50%" style='font-size: 1em;'><?= $this->render('_print_client', ['model' => $model->client]) ?></td>
	</tr>
	</table>
	<br>
	<br>
	...
	<h4 style='font-size: 1.2em; font-weight: bold;'><?= Yii::t('store', ($model->document_type == Document::TYPE_ORDER && $model->bom_bool) ? Document::TYPE_BOM : $model->document_type).' '.$model->name ?></h4>
